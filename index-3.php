...
<!-- Mirrored from world5.commonsupport.com/html2/kindergarten/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Mar 2023 10:53:26 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="slider1" class="rev_slider"  data-version="5.0">
        <ul>
            <li class="gradient-overlay" data-transition="slotzoom-horizontal" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/3.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
                ...
                data-endspeed="1200"
                data-endeasing="Power4.easeIn"><img src="images/main-slider/6.png" alt=""></div>
            ...
            <li class="gradient-overlay" data-transition="slotzoom-horizontal" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/2.jpg"  data-saveperformance="off"  data-title="Awesome Title Here">
...
<section class="intro-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0" style="visibility: visible; animation-duration: 0s; animation-delay: 0.5s; animation-name: fadeIn;">
                <div class="img-holder">
                    <figure><a href="#"><img src="images/resource/10.jpg" alt="Awesome Image"/></a></figure>
                    <div class="content">
                        <div class="inner-box">
                            <h3>Active learning</h3>
                            <a href="#" class="bg-color-1">Read More <span class=""></span></a>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeIn;">
                <div class="img-holder">
                    <figure><a href="#"><img src="images/resource/11.jpg" alt="Awesome Image"/></a></figure>
                    <div class="content">
                        <div class="inner-box">
                            <h3>Active learning</h3>
                            <a href="#" class="bg-color-2">Read More <span class=""></span></a>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0" style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: fadeIn;">
                <div class="img-holder">
                    <figure><a href="#"><img src="images/resource/12.jpg" alt="Awesome Image"/></a></figure>
                    <div class="content">
                        <div class="inner-box">
                            <h3>Active learning</h3>
                            <a href="#" class="bg-color-3">Read More <span class=""></span></a>
                        </div>
                    </div>
        ...
        <div class="see-more style-3">
            <div class="clearfix">
                <div class="link pull-left">
                    <a href="#" class="link-btn">How to Enroll Your Child to a Class?</a>
                </div>
                <div class="link pull-right">
                    <a href="#" class="link-btn border-bottom">Learn More</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0" style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: fadeIn;">
                    <div class="post-content">
                        <div class="section-title">
                            <h2>Why Choose <span>Nashville Kinder Garten</span> </h2>
                        </div>
                        <div class="text">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="chose-info">
                                    <div class="item">
                                        ...
                                        <h4><a href="#">Play Area</a></h4>
                                    </div>
                                    <div class="item">
                                        <div class="icon"><span class="icon-library"></span></div>
                                        <h4><a href="#">Activity Rooms</a></h4>
                                    </div>
                                    <div class="item">
                                        <div class="icon"><span class="icon-library"></span></div>
                                        <h4><a href="#">Music And Art Room</a></h4>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="chose-info">
                                    ...
                                    <div class="item">
                                        <div class="icon"><span class="icon-library"></span></div>
                                        <h4><a href="#">Varied Classes</a></h4>
                                    </div>
                                    <div class="item">
                                        <div class="icon"><span class="icon-library"></span></div>
                                        <h4><a href="#">Multimedia Centre</a></h4>
                                    </div>
            ...
            <div class="single-column col-md-6 col-sm-12">  
                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0" style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: fadeIn;">
                    <figure class="img-box">
                        <a href="#"><img src="images/resource/3.png" alt=""></a>
                    </figure>
                </div> 
            </div>
        </div>
...
<section class="call-out bg-style2">
    <div class="container">
        <div class="row">
...
<section class="popular-class">
    <div class="container">
        <div class="section-title center pb-60">
            <h2>Our Popular <span>Class</span></h2>
        </div>
...
<section class="two-column style-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <div class="upcoming-event">
                    ...
                    <div class="link">
                        <a href="#" class="link-btn">View All <span class=""></span></a>
                    </div>
...
<section class="sponser-section pdt-40 style-2">
    <div class="container">
    ...
    <div class="container">
        <div class="footer-upper">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column">
                    <div class="instagram single-widget">
                        <div class="column-title">
                            <h2>Event Gallery</h2>
                        </div>
...
<!-- Mirrored from world5.commonsupport.com/html2/kindergarten/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Mar 2023 10:53:27 GMT -->
</html>
